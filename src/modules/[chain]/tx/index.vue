...
<template>
    <div>
        ...
        <div v-show="tab === 'recent'" class="bg-base-100 dark:bg-[#181D27] rounded overflow-x-auto">
        ...
        <div v-show="tab === 'search'" class="bg-base-100 dark:bg-[#181D27] rounded overflow-x-auto">
            <div class="p-4">
